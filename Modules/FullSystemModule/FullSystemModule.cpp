// FullSystemModule.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
extern "C" __declspec(dllexport) void RunModule()
{
    ...
    cout << "I require network scanning module!\n";
    cout << "I require ransomware module!\n";
    cout << "I require 62 bytes of setting data!\n";
}
