// NetworkScannerModule.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
extern "C" __declspec(dllexport) void RunModule()
{
    ...
    cout << "I require library module\n";
    cout << "I am the network scanner module\n";
}
